...
mixin _$AuthUser {
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, email, displayName, avatarIndex);

  @override
  String toString() {
    return 'AuthUser(id: $id, email: $email, displayName: $displayName, avatarIndex: $avatarIndex)';
  }
}
...
abstract mixin class $AuthUserCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String email, String displayName, int avatarIndex});
}
...
extension AuthUserPatterns on AuthUser {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(
            String id, String email, String displayName, int avatarIndex)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _AuthUser() when $default != null:
        return $default(
            _that.id, _that.email, _that.displayName, _that.avatarIndex);
      case _:
        return orElse();
    }
  }
