...
mixin _$AppSettings {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.nightLight, nightLight) ||
                other.nightLight == nightLight) &&
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, soundEffects, nightLight, readingLevel);

  @override
  String toString() {
    return 'AppSettings(soundEffects: $soundEffects, nightLight: $nightLight, readingLevel: $readingLevel)';
  }
}
...
abstract mixin class $AppSettingsCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool soundEffects, bool nightLight, ReadingLevel readingLevel});
}
...
extension AppSettingsPatterns on AppSettings {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(
            bool soundEffects, bool nightLight, ReadingLevel readingLevel)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _AppSettings() when $default != null:
        return $default(
            _that.soundEffects, _that.nightLight, _that.readingLevel);
      case _:
        return orElse();
    }
  }
...
class _AppSettings implements AppSettings {
  const _AppSettings(
      ...
      this.readingLevel = ReadingLevel.earlyReader});
